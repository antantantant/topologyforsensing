...
loadnid = (nelx/2*(nely+1)+1):(nelx+1)*(nely+1):(nelx+1)*(nely+1)*(nelz+1);
loaddof = 3*loadnid(:) - 1;
...
fixednid = (nely+1):(nelx+1)*(nely+1):(nelx+1)*(nely+1)*(nelz+1);
fixeddof = [3*fixednid(:); 3*fixednid(:)-1; 3*fixednid(:)-2]; % DOFs
fixednid = (nely+1)*(nelx+1):(nelx+1)*(nely+1):(nelx+1)*(nely+1)*(nelz+1);
fixeddof = [fixeddof;3*fixednid(:); 3*fixednid(:)-1; 3*fixednid(:)-2]; % DOFs
